  ...
  Vue.component('VueFooter', {
    template:`
    <footer>
      <a style="font-size: 18px;">@2019 Onur Salman <a style="text-decoration:none; font-size:18px; color:#000;" href="http://www.github.com/onurrsalmann">www.github.com/onurrsalmann</a></a>
    </footer>
    `
  });
  window.vue = new Vue({
    ...
    methods: {
      ...
      sendText: function () { /* Text to Morse*/
        ...
        if(reg.test(this.text,reg))
        {
          alert('Please enter text that does not contain Turkish characters here.');
        }else{
      ...
      sendMorse: function () { /*Morse to Text*/
        var letters = [ ' ', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j',
          'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x',
          'y', 'z', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0' ];
        var morseLetters = [ "\xa0\xa0\xa0\xa0", ".-", "-...","-.-.",
          ...
          "...-", ".--", "-..-", "-.--", "--..", ".----","..---", "...--",
          "....-", ".....","-....", "--...", "---..", "----.", "-----" ];
        var text=''; var convertText=''; var bosluk=0; var char='';
        var morsee= this.morse + "    ";
        for (var k = 0; k < morsee.length; k++){
          if(morsee[k] == ' '){
            if(morsee[k+1] == ' '){ var bosluk= k+1;}
            var bosluk= k;
            if (char != ''){
